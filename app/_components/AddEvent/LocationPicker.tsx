...
export default function LocationPicker({
    ...
    return (
        <div className="lg:grid lg:grid-cols-3 gap-4">
            <div>
                {!location && (
                    <p>Wpisz miejsce wydarzenia, aby odszukać je na mapie</p>
                )}
                <button
                    type="button"
                    className="btn btn-primary"
                    onClick={fetchGeoCoding}
                    disabled={!location}
                >
                    Znajdź na mapie
                </button>
                <p>
                    ...
                    >
                        Wyszukiwanie dzięki CAPAP
                    </a>
                </p>
                <InfoText>
                    Jeśli chcesz dostosować lokalizację swojego wydarzenia, użyj
                    opcji przeciągnięcia pinezki na mapie. Po prostu złap
                    pinezkę i przesuń ją na właściwe miejsce na mapie.
                </InfoText>
            </div>
                ...
                <BaseMap>
                    {geoPoint && (
                        <Marker
                            ...
                            draggable
                            onDragEnd={(e) =>
                                setGeoPoint([e.lngLat.lng, e.lngLat.lat])
                            }
                        >
                            <svg
                                height="50"
